"""
Django settings for lan_group project.
...
CRONJOBS = [
    ('30 17 * * 1', 'duties.cron.email_scheduled_job'),  # 每周一17点执行
]
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'lan_group@outlook.com'
EMAIL_HOST_PASSWORD = 'nonadiabatic2024'
